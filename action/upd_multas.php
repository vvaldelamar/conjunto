...
<?php
	...
	if (empty($_POST['mod_id'])) {
        ...
        $fecha_mes=mysqli_real_escape_string($con,(strip_tags($_POST["mod_created_at"],ENT_QUOTES)));
		$id=intval($_POST['mod_id']);

		//fecha_mens LA MULTA ES UN CONCEPTO QUE VA COMO MENSUALIDAD NO USA EL CAMPO DE FECHA DE PAGO 
        ...
        $numrows = $row['numrows'];	
			...
			{ $errors []= "No tienes permisos para hacer cambios."; }
				...
				{	
					...
					$sql="UPDATE base SET notas=\"$description\",mens=$amount,category_id=$category,fecha_mens=\"$fecha_mes\" WHERE id_tabla=$id";
