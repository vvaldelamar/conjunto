        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                       ...
                       <!--  <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pic_profile"><img src="images/user1.png" alt="Perfil Usuario" width="70">
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                 <br>
                                <span class="btn btn-my-button btn-file">
                                    Selecionar una imagen <input type="file" id="pic_profile" name="image" >
                                </span>
                            </div>
                        </div> -->
                        <!-- <div class="form-group">
                            <label class="control-label col-md-5 col-sm-5 col-xs-12">
                                <input type="checkbox" class="flat" name="is_admin" > Administrador
                            </label>
                        </div> -->
