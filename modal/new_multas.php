<form class="form-horizontal form-label-left input_mask" method="post" id="add_multas" name="add_multas">
    <div> 
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-new"><i class="fa fa-plus-circle"></i> Agregar Multas</button>
    </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Nueva Multas </h4>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <select class="form-control" name="casa" required>
                                    ...
                                    <option value="<?php echo $cat['casa']; ?>"><?php echo $cat['propietario'] ; ?> <b> <?php echo $cat['casa'] ; ?></b> </option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>              
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <select class="form-control" name="category" required>
                                    <option selected="" value="">-- Selecciona Categoria --</option>
                                    <?php
                                    $categories = mysqli_query($con,"select * from category_income where id=4");
                                    while ($cat=mysqli_fetch_array($categories)) { ?>
