                ...
                <footer><!-- footer content -->
                    <div class="pull-right">
                        Copyright © <?php echo date("Y");?> <a target="_blank"  href="https://ingeniero-web.com">Sistema de Pagos</a> All rights reserved. 
                    </div>
        ...
        <script src="js/Buttons-2.2.3/js/buttons.html5.min.js"></script>
