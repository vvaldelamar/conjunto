<?php
    ...
    if (!in_array('cat_Ingresos',$_SESSION['modulos'])) {
        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Categorias <small>Ingresos</small></h2>
     ...
     $.ajax({
            ...
            data: parametros,
             beforeSend: function(objeto){
                $("#result_c_income").html("Mensaje: Cargando...");
              },
            success: function(datos){
            $("#result_c_income").html(datos);
...
$( "#upd_c_income" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
     $.ajax({
            ...
            data: parametros,
             beforeSend: function(objeto){
                $("#result_c_income2").html("Mensaje: Cargando...");
              },
            success: function(datos){
            $("#result_c_income2").html(datos);
